...
const Grid = ({
  handleFlag, handleKeyPress, onClickForward, onClickBack, index, modal, photos, handleImageClick, flag,
}) => {
  const imgURL = [];
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.column4}>
          ...
          <div className={styles.box9} onClick={() => { handleImageClick(8); }}>
            ...
            <img src={imgURL[8]} height="91" width="91" /></div>
        </div>
        {modal && <Modal handleFlag={handleFlag} handleKeyPress={handleKeyPress} onClickForward={onClickForward} onClickBack={onClickBack} index={index} handleImageClick={handleImageClick} imgURL={imgURL} flag={flag} />}
      </div>
    </div>
  );
};
