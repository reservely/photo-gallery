...
const Banner = ({handleKeyPress, onClickForward, onClickBack, index, modal, photos, handleImageClick}) => {
  const imgURL = [];
  {photos.map(photo => imgURL.push(photo))};
  
  return (
    <div>
      <div className={[styles.box1]}><img src={imgURL[9]} width='1377' height='306' onClick={() => {handleImageClick(0)}}/></div>
