...
const Modal = ({flag, handleFlag, handleKeyPress, onClickBack, onClickForward, imgURL, index, handleImageClick}) => {
  const left = '<';
  const right = '>';
  ...
  return (
    <div className={styles.modal}>
      ...
      <div className={styles.outsideContainer}>
        ...
        {
             flag &&<span className={styles.flagbox}> <img src='https://reservly-photos.s3-us-west-1.amazonaws.com/alertbox.png' onClick = {()=>handleFlag()}/> </span>
        }
